...
def generate_guidance_summary_with_openai(
    ...
    "- the specific question types this document should handle\n"
    "- the exact coaching route the assistant should follow\n"
    "- which ideas must be reinforced\n"
    "- which concrete signals or diagnostic markers should be mentioned when relevant\n"
    "- what the assistant must avoid doing\n"
    "- instruction to follow the pattern without copying wording\n\n"
    "Where relevant, prefer specific guidance over generic coaching.\n"
    "If the document describes tactics or difficult behaviours, capture:\n"
    "- tactics as gameplay, not real positions\n"
    "- balanced playing field\n"
    "- confidence\n"
    "- Five Elements\n"
    "- tactics preparation\n"
    "- signs such as one-sided asks, pressure, unreasonable timelines, flattery, good cop, Soft Coal\n"
    "- avoid defaulting to generic variable coaching first\n"
)
